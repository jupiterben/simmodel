...
Quantity< BaseUnit< typename dim_plus<typename U1::Dimension, typename U2::Dimension>::type > >  operator*(const Quantity<U1>& q1, const Quantity<U2>& q2)
{
	double val =  q1.base_value() * q2.base_value();
	Quantity< BaseUnit< dim_plus<U1::Dimension,U2::Dimension>::type > > q;
	q.value(val);
	return q;
}

template<class U1,class U2>
Quantity< BaseUnit< typename dim_minus<typename U1::Dimension, typename U2::Dimension>::type > >  operator/(const Quantity<U1>& q1, const Quantity<U2>& q2)
{
	double val =  q1.base_value() * q2.base_value();
	Quantity< BaseUnit< dim_minus<U1::Dimension,U2::Dimension>::type > > q;
	q.value(val);
	return q;
}
